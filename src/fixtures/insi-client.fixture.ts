...
export const getCNDAValidationXmlRequest = ({ idam, version, name, birthName, firstName, gender, dateOfBirth, assertionPs, requestDate = defaultDate, requestId = defaultUuid }: IGetCNDAXmlRequestParams): string => {
  return [
    '<?xml version="1.0" encoding="utf-8"?>',
