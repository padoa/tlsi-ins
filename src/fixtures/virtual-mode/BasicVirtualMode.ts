...
export default class BasicVirtualMode {
  ...
  private static _getXmlRequest(firstNameResquest: string, { idam, version, name, requestDate, requestId, emitter }: INSiServiceRequestEnv): string {
    return [
  ...
  private static _getValidXmlResponse(): string {
