...
exports.getXmlRequestTest = getXmlRequestTest;
const getNoIdentityXmlResponseTest = () => {
    return [
        '<?xml version="1.0" encoding="UTF-8"?>\n',
...
exports.getNoIdentityXmlResponseTest = getNoIdentityXmlResponseTest;
const getXmlInsHisto = (insHisto) => {
    return insHisto.map((insHisto) => {
        return [
            '<INSHISTO>',
            '<IdIndividu>',
...
const getValidXmlResponseTest = (personDetails, insHisto = []) => {
    var _a, _b;
    const numIdentifiant = (_a = personDetails.registrationNumber) === null || _a === void 0 ? void 0 : _a.slice(0, -2);
    const cle = (_b = personDetails.registrationNumber) === null || _b === void 0 ? void 0 : _b.slice(-2);
...
exports.getValidXmlResponseTest = getValidXmlResponseTest;
//# sourceMappingURL=xml-request-tester.js.map